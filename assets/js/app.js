...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).ready(function () {
  ...
  initSmoothScroll(); //////// Cursor Section ////////////
  ...
  $hoverables.on('mouseleave', onMouseHoverOut); // Move the cursor

  function onMouseMove(e) {
    gsap_dist_gsap__WEBPACK_IMPORTED_MODULE_2__["gsap"].to($stroke, {
      duration: 0.4,
      x: e.clientX - 25,
      y: e.clientY - 26
    });
    gsap_dist_gsap__WEBPACK_IMPORTED_MODULE_2__["gsap"].to($ball, {
      duration: 0.1,
      x: e.clientX - 5,
      y: e.clientY - 12
    });
  ...
  gsap_dist_gsap__WEBPACK_IMPORTED_MODULE_2__["gsap"].to('.text-frontend', {
    scrollTrigger: {
  ...
  gsap_dist_gsap__WEBPACK_IMPORTED_MODULE_2__["gsap"].to('.text-developer', {
    scrollTrigger: {
      trigger: '.home-landing',
      start: 'center center',
      scrub: .5
  ...
  gsap_dist_gsap__WEBPACK_IMPORTED_MODULE_2__["gsap"].to('.spinny-boy', {
    scrollTrigger: {
      trigger: '.spinny-boy',
      start: 'top bottom',
      scrub: .5
  ...
  if (Foundation.MediaQuery.is('medium up')) {
    gsap_dist_gsap__WEBPACK_IMPORTED_MODULE_2__["gsap"].to('.info-parallax-text', {
      scrollTrigger: {
        trigger: '.home-info',
        start: 'top center',
        scrub: .5
...
module.exports = __webpack_require__(/*! F:\Dev Work\sites\personal\src\assets\js\app.js */"./src/assets/js/app.js");
